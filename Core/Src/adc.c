...
void HAL_ADC_MspDeInit(ADC_HandleTypeDef* adcHandle)
{
  ...
  /* USER CODE END ADC1_MspDeInit 0 */
    ...
    PA4     ------> ADC1_IN4 
    */
    HAL_GPIO_DeInit(GPIOC, Battery_Voltage_ADC1_CH10_Pin|RSSI1_ADC1_CH12_Pin);

    HAL_GPIO_DeInit(NTC_ADC1_CH4_GPIO_Port, NTC_ADC1_CH4_Pin);
  ...
  /* USER CODE END ADC2_MspDeInit 0 */
    ...
    PB0     ------> ADC2_IN8 
    */
    HAL_GPIO_DeInit(M1_ADC2_CH8_AWD_GPIO_Port, M1_ADC2_CH8_AWD_Pin);
  ...
  /* USER CODE END ADC3_MspDeInit 0 */
    ...
    PA3     ------> ADC3_IN3 
    */
    HAL_GPIO_DeInit(M2_ADC3_CH3_AWD_GPIO_Port, M2_ADC3_CH3_AWD_Pin);
